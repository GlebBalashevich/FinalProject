...
<nav class="navbar navbar-light navbar-expand-md navbar navbar-expand-lg fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand shadow-none js-scroll-trigger" id="brandLogo"
                              href="process_controller?command=move_home_page">Car|Book</a>
        ...
        <div class="collapse navbar-collapse text-success" id="navbarResponsive">
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item nav-link js-scroll-trigger" role="presentation">
                    <a class="nav-link js-scroll-trigger" href="#cars">
        ...
        <div class="col" id="lang_switch" style="max-width: 60px">
            <div class="row">
                <div class="col text-right"><a href="process_controller?command=switch_locale&locale=ru">|РУ</a></div>
            </div>
            <div class="row">
                <div class="col text-right"><a href="process_controller?command=switch_locale&locale=en">|EN</a></div>
            </div>
        </div>
    </div>
</nav>