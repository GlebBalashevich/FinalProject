                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" name="rent_cost" type="number"
                                                           minlength="1" maxlength="2" min="10" max="200" value="${carElement.rentCost}">
                                                </td>
                                                <td><fmt:message key="admin_cars.is_available"/></td>
                                                <td colspan="2">
                                                    <div class="form-group">
                                                        <select id="select" size="1" class="form-control" name="is_available">
                                                            <option value="${carElement.available}">
                                                                <fmt:message key="admin_cars.avail_now"/>"${carElement.available}"</option>
                                                            <option value="true"><fmt:message key="admin_cars.avail_change_to_true"/></option>
                                                            <option value="false"><fmt:message key="admin_cars.avail_change_to_false"/></option>
                                                        </select>
                                                    </div>
                                                </td>
                                            </tr>
